...
const FAQ = () => {
  ...
  const faqs = [
    {
      question: "Comment fonctionne l'IA Deepseek v3 ?",
      answer: "Notre IA Deepseek v3 utilise des algorithmes d'apprentissage profond pour analyser votre profil professionnel, vos ambitions et les données du marché. Elle génère ensuite des prédictions personnalisées sur votre évolution de carrière, identifie vos forces cachées et recommande des stratégies spécifiques à votre secteur d'activité.",
    ...
    },
    {
      ...
      answer: "Le processus est ultra-rapide ! Après avoir complété le formulaire (2-3 minutes), notre IA Deepseek v3 génère votre rapport en moins de 3 minutes. Vous recevez immédiatement un lien de téléchargement et une copie par email. L'ensemble du processus prend moins de 10 minutes du début à la fin.",
      category: "Timing"
    },
    {
    ...
    },
    {
      ...
      answer: "Chaque rapport est 100% unique et personnalisé. L'IA Deepseek v3 analyse spécifiquement votre profil, votre secteur, votre poste et vos ambitions pour générer du contenu sur-mesure. Aucun deux rapports ne sont identiques, car ils reflètent votre situation professionnelle unique et vos objectifs personnels.",
    ...
    },
    {
      ...
      answer: "Oui, notre IA Deepseek v3 a été entraînée sur des données de plus de 200 secteurs d'activité différents. Que vous soyez dans la tech, la finance, la santé, l'industrie, le commerce ou tout autre domaine, l'IA adapte son analyse aux spécificités de votre secteur et aux tendances actuelles du marché.",
      category: "Secteurs"
    }
  ];
